...
const SheetCross = ({ disabled } : { disabled: boolean }) => {
  if(disabled) {
    return (
...
const SheetContent = React.forwardRef<
  ...
  SheetContentProps & { hideCross?: boolean, disabledCross?: boolean }
>(({ side = "right", className, hideCross = false, disabledCross = false, children, ...props }, ref) => (
  <SheetPortal>
    <SheetOverlay />
    <SheetPrimitive.Content
      ...
      {...props}
    >
      {!hideCross && <SheetCross disabled={disabledCross} />}
      {children}
    </SheetPrimitive.Content>
  </SheetPortal>
))
